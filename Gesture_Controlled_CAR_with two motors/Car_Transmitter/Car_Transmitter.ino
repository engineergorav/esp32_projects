...
uint8_t receiverMacAddress[] = {0x08, 0xA6, 0xF7, 0xB1, 0x12, 0x58};  // 08:A6:F7:B1:12:58
...
void loop() 
{
  ...
  {  
    ...
    // Map sensor values to byte range
    ...
    delay(50);  // Small delay for smoother data transmission
  }
}
